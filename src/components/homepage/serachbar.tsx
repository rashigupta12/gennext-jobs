...
const JobSearchSection = () => {
  ...
  return (
    <section className="max-w-6xl mx-auto -mt-16 relative z-20 px-4 sm:px-6">
        ...
        <div className="p-6 md:p-8">
          ...
          <form onSubmit={handleSearch}>
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <button
                type="submit"
                className={`w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white font-medium py-3.5 px-8 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 active:translate-y-0 ${
